...
As of now the app is kind of bare; I would've loved to experiment more with creating different groups of todo-items, color pickers, implementing local storage, deletion animations as well as [@atlassians](https://github.com/atlassian) [drag-and-drop](https://github.com/atlassian/react-beautiful-dnd).
